...
VALUES(2,'2023/03/12','Sole/MezzOmbra','Qlus Nimus',2,2,2,1),
	  ...
	  (9,'2021/04/07','MezzOmbra','Alakazam',1,3,3,3) ,
	  (10,'2023/09/03','MezzOmbra','Kadabra',3,4,3,5) ,
	  (11,'2023/09/03','MezzOmbra','Abra',3,4,3,5);
